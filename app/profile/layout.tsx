        ...
        <div className="mt-8 flex flex-col bg-white border shadow-sm rounded-xl dark:border-neutral-700 dark:shadow-neutral-700/70">
          <div className="hidden sm:block">
            <nav className="relative z-0 flex border-b rounded-xl divide-x divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700">
              <a
                className="group hover:text-black relative min-w-0 flex-1 py-4 px-4 border-b-2 border-b-blue-600 text-gray-900 rounded-ss-xl text-sm font-medium text-center overflow-hidden hover:bg-gray-50 focus:outline-none focus:bg-gray-50 focus:z-10 bg-[#00AAFF] dark:border-blue-500 dark:text-white"
                aria-current="page"
                href="#"
              >
                Tantang Saya
              ...
              <a
                className="group hover:text-black relative min-w-0 flex-1 py-4 px-4 text-gray-500  text-sm font-medium text-center overflow-hidden hover:bg-gray-50 focus:outline-none focus:bg-gray-50 focus:z-10 bg-[#00AAFF]  text-white text-white"
                href="#"
              >
                Pengalaman Kerja
              </a>
              ...
              <a
                className="group hover:text-black relative min-w-0 flex-1 py-4 px-4 text-gray-500  rounded-se-xl text-sm font-medium text-center overflow-hidden hover:bg-gray-50 focus:outline-none focus:bg-gray-50 focus:z-10 bg-[#00AAFF]  text-white text-white"
                href="#"
              >
                Skill
              </a>
